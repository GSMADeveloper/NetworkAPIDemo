...
public class ParameterList {
	...
	public String getValue(String key) {
		Log.d(TAG, "Looking for "+key);
		boolean found=false;
		String value=null;
		if (key!=null) {
			for (int i=0; i<parameterList.size() && !found; i++) {
				Log.d(TAG, "Checking "+parameterList.get(i).getKey());
	...
	public static ParameterList getKeyValuesFromUrl(String url) {
		...
		parameterList.loadKeyValuesFromUrl(url);
		return parameterList;
	}
	
	public void loadKeyValuesFromUrl(String url) {
